...
**6社中2社が A8 提携リンク**（2026-08-03 時点）。

| 会社 | リンク | 状態 |
|---|---|---|
| 松井証券 | A8 提携リンク（`a8-active`） | 2026-07-15 承認 |
| DMM 株 | A8 提携リンク（`a8-active`） | 2026-07-14 承認 |
| SBI証券 / 楽天証券 / マネックス証券 / 三菱UFJ eスマート証券 | 素の公式サイトURL（`official`） | 未提携（eスマートは A8 審査中） |

`a8-active` の2社は PR バッジ・`rel="nofollow sponsored"`・ページ上部の「PR — 広告を含む」表示が出る。
